    ...
    return <>
        {isLoading ? <section id='loading' className='vh-100 myBg d-flex justify-content-center align-items-center'>
            ...
            <form onSubmit={formik.handleSubmit}>
                ...
                <input className='my-2 form-control' type="text" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.resetCode} id='resetCode' name='resetCode' />
